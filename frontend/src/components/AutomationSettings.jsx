...
export default function AutomationSettings({ setActivePage, targetId }) {
              ...
              <div className="flex-grow grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div className="flex flex-col gap-1.5 relative group/field">
                  <div className="flex justify-between items-end px-1 mb-0.5">
                    ...
                    <button
                      onClick={() => {setActivePage("automationProtocol"); targetId(item.Protocol)}}
                  ...
                  <div className="relative">
                    ...
                    >
                      ...
                      {AutomationProtocols.map(p => <option key={p.ID} value={p.ID} className="bg-slate-900">{p.Name}</option>)}
                    </select>
