...
export default function DotSettings({ onNavigate }) {
    ...
    useEffect(() => {
        const fetchData = async () => {
            const res1 = await triggerTableContent({ tableName: "SettingsDot" });
                    ...
                    <input type="hidden" value={item.DeviceID || ""} />
                                ...
                                <div className="flex flex-col gap-1.5 group/field">
                                    <div className="flex justify-between items-center px-1">
                                        <label className="text-[11px] font-bold text-slate-500 uppercase">Volume</label>
                                ...
                                <div className="flex flex-col gap-1.5 group/field">
                                    <div className="flex justify-between items-center px-1">
                                        <label className="text-[11px] font-bold text-slate-500 uppercase">UnitPrice</label>
                                        <button className="text-slate-400 hover:text-emerald-500 transition-colors">
                                            <Activity size={12} />
                                        </button>
                                    </div>
                                ...
                                <div className="flex flex-col gap-1.5 group/field">
                                    <div className="flex justify-between items-center px-1">
                                        <label className="text-[11px] font-bold text-slate-500 uppercase">TotalVolume</label>
                                        <button className="text-slate-400 hover:text-emerald-500 transition-colors">
                                            <Activity size={12} />
                                        </button>
                                    </div>
                                    <div className="flex items-center bg-slate-50 border border-slate-200 rounded-xl px-3 focus-within:bg-white focus-within:ring-2 focus-within:ring-blue-100 transition-all">
                                        ...
                                        <input
                                            ...
                                            onChange={(e) => handleInputChange(index, 'TotalVolume', e.target.value)}
                                            className="bg-transparent border-none w-full text-sm font-bold p-3 outline-none"
                                        />
                                    </div>
                                </div>
                                ...
                                <div className="flex flex-col gap-1.5 group/field">
                                    <div className="flex justify-between items-center px-1">
                                        <label className="text-[11px] font-bold text-slate-500 uppercase">TotalAmount</label>
                                        <button className="text-slate-400 hover:text-emerald-500 transition-colors">
                                            <Activity size={12} />
                                        </button>
                                    </div>
